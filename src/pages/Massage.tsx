...
const massageServices = [
  ...
  },
  {
    ...
    description: "Safe and nurturing massage for expectant mothers",
    price: "£140",
    duration: "90 mins",
    benefits: ["Reduces back pain", "Decreases swelling", "Improves sleep", "Reduces anxiety"],
    image: massageImg,
  },
  {
    title: "Post-Op Massage",
    description: "Specialized recovery massage after surgical procedures",
    price: "£180",
    duration: "90 mins",
    benefits: ["Speeds recovery", "Reduces swelling", "Breaks up scar tissue", "Promotes healing"],
    image: massageImg,
    isPopular: true,
  },
  {
  ...
  },
  {
    ...
    description: "Classic full body massage using long flowing strokes",
    price: "£90",
    duration: "60 mins",
    benefits: ["Increases oxygen", "Improves circulation", "Reduces toxins", "Relaxation"],
    image: massageImg,
  },
  {
    title: "Cupping with Deep Tissue",
    description: "Traditional cupping therapy combined with deep tissue work",
    price: "£140",
    duration: "90 mins",
    benefits: ["Pain relief", "Improves blood flow", "Reduces inflammation", "Muscle recovery"],
    image: massageImg,
  },
];
